downscale_processed<-function(processed,target_Inh,target_Conc,Fitted_Model,mean_curve,imped.pca){
      require(fda)
      ...
      for (i in 1:length(target_Conc)){
            estimated_curve<-imped.pca$harmonics[1]*predicted_values[i]+mean_curve
